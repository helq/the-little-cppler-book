...
\VERB|\NormalTok{&&}|:\footnote{the parthesis around the boolean
...
\tightlist
\item
  recursive functions, input, streams, vector, strings (optional)
\end{enumerate}
...
\item
  explain what a stream is and their hierarchy, lots of examples reading
  and writing to files
\item
  show problems of traditional function declarations, and explain how to
  a declare/define a function using template
\item
\end{itemize}
